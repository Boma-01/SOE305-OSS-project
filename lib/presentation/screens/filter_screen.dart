// this is a filter && and search bar that filters rooms based on price, it also uses basic exception handling in the search implementation
...
class _FilterPageState extends State<FilterPage> {
  ...
  final List<Room> rooms = [
    Room("Deluxe Room 1", "Deluxe", "84k", "assets/images/deluxe-hostel.jpg"),
    Room("Deluxe Room 2", "Deluxe", "84k", "assets/images/deluxe-hostel.jpg"),
    Room(
      "Premier Room 1",
      "Premier",
      "42k",
      "assets/images/premier-hostel.jpg",
    ),
    Room(
      "Premier Room 2",
      "Premier",
    ...
    Room(
      ...
      "Economy",
      "21k",
      "assets/images/economy-hostel.jpg",
    ),
    Room(
      "Economy Room 2",
      "Economy",
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              if (constraints.maxWidth >= 900) {
                ...
                childAspectRatio = 1.3; // reduce overall container height
